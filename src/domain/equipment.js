...
const PT_BR_ALIASES = {
  ...
  'couro': 'leather',
  'gibão de couro batido': 'studded-leather',
  'armadura de couro batido': 'studded-leather',
  'armadura de couro cravejado': 'studded-leather',
  'couro batido': 'studded-leather',
  'couro cravejado': 'studded-leather',
  'gibão de peles': 'hide',
  'peles': 'hide',
