...
export function Chip({ active = false, onClick, children, ariaLabel, className = '', ...rest }) {
  const base = 'inline-flex items-center gap-1 text-[13px] uppercase tracking-wider px-2 py-1 rounded border transition-colors font-[var(--font-redesign-sans)] font-semibold'
  const state = active
