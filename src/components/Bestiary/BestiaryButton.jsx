  ...
  return (
    <>
      <button
        ...
        className="w-12 h-12 rounded-full text-xl flex items-center justify-center transition-colors duration-200 border-2 bg-parchment-100/60 hover:bg-parchment-200/90 border-ink-300/70 hover:border-ink-500 shadow-parchment backdrop-blur-sm cursor-grab active:cursor-grabbing"
      >
        🐉
      </button>
